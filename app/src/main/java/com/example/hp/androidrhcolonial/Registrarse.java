...
// se crea una instancia  de firebase para poder manipular los datos
        final FirebaseDatabase database=FirebaseDatabase.getInstance();
        final DatabaseReference tabla_usuario=database.getReference("Usuario");
        btnRegistrarse.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                final ProgressDialog mDialogo=new ProgressDialog(Registrarse.this);
                ...
                tabla_usuario.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        {
                            mDialogo.dismiss();
                            Toast.makeText(Registrarse.this,"Numero de telefono ya registrado",Toast.LENGTH_SHORT).show();
                        }else
                        {
                            mDialogo.dismiss();
                            ...
                            Toast.makeText(Registrarse.this,"Registrado Felicidades",Toast.LENGTH_SHORT).show();
